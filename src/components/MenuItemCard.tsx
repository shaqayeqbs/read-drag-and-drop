...
export const MenuItemCard: React.FC<MenuItemCardProps> = ({
  ...
  const getFallbackImage = (category: string) => {
    const fallbacks = {
      ...
      pasta: "https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=300&h=200&fit=crop",
      ...
      sandwich: "https://images.unsplash.com/photo-1481070414801-51fd732d7184?w=300&h=200&fit=crop",
    };
    return fallbacks[category as keyof typeof fallbacks] || "https://via.placeholder.com/300x200?text=No+Image";
  };
        ...
        {item.image && !imageError ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gray-200 dark:bg-gray-600">
            <div className="text-center">
              <div className="text-4xl mb-2">{getCategoryPlaceholder(item.category)}</div>
