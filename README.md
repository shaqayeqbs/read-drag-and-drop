...
This app uses Firebase for backend services (authentication, database, etc.).
...
3. (Optional) Configure additional providers if needed
...
1. Go to [Firebase Console](https://console.firebase.google.com/project/orderfood-c0928/settings/general)
2. Scroll to "Your apps" section
3. If no web app exists, click "Add app" → Web app (</>) → Register app
...
After setting up Firestore, run the seed script to upload menu data:
