...
declare function createAuthClient<Option extends BetterAuthClientOptions>(options?: Option | undefined): UnionToIntersection<InferResolvedHooks<Option>> & InferClientAPI<Option> & InferActions<Option> & {
  ...
  $fetch: _better_fetch_fetch80.BetterFetch<{
    plugins: (_better_fetch_fetch80.BetterFetchPlugin<Record<string, any>> | {
      ...
      name: string;
      hooks: {
        onSuccess(context: _better_fetch_fetch80.SuccessContext<any>): void;
      };
    } | {
      id: string;
      name: string;
      hooks: {
        onSuccess: ((context: _better_fetch_fetch80.SuccessContext<any>) => Promise<void> | void) | undefined;
        onError: ((context: _better_fetch_fetch80.ErrorContext) => Promise<void> | void) | undefined;
        onRequest: (<T extends Record<string, any>>(context: _better_fetch_fetch80.RequestContext<T>) => Promise<_better_fetch_fetch80.RequestContext | void> | _better_fetch_fetch80.RequestContext | void) | undefined;
